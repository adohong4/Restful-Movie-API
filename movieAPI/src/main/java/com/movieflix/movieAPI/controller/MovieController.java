...
import com.movieflix.movieAPI.exeption.EmptyFileException;
...
public class MovieController {
    ...
    public ResponseEntity<String> deleteMovieIdHandler(@PathVariable Integer movieId) throws IOException {
